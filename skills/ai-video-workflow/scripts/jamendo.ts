...
import { formatJamendoAlbums, formatJamendoArtists, formatJamendoTracks } from "./formatters";
...
async function searchTracks(flags: Record<string, string>) {
  ...
  if (flags["--output"]) {
    ...
    console.log(formatJamendoTracks(data));
  }
}
...
async function searchAlbums(flags: Record<string, string>) {
  ...
  if (flags["--output"]) {
    ...
    console.log(formatJamendoAlbums(data));
  }
}
...
async function searchArtists(flags: Record<string, string>) {
  ...
  if (flags["--output"]) {
    ...
    console.log(formatJamendoArtists(data));
  }
}
